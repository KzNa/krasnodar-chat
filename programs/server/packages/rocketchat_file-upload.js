...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
Slingshot.fileRestrictions('rocketchat-uploads', {                                                                     // 1
	authorize: function (file, metaContext) {                                                                             // 2
		if (!RocketChat.fileUploadIsValidContentType(file.type)) {                                                           // 3
			throw new Meteor.Error(TAPi18n.__('Invalid_file_type'));                                                            // 4
		}                                                                                                                    //
                                                                                                                       //
		var maxFileSize = RocketChat.settings.get('FileUpload_MaxFileSize');                                                 // 7
                                                                                                                       //
		if (maxFileSize && maxFileSize < file.size) {                                                                        // 9
			throw new Meteor.Error(TAPi18n.__('File_exceeds_allowed_size_of_bytes', { size: maxFileSize }));                    // 10
		}                                                                                                                    //
                                                                                                                       //
		//Deny uploads if user is not logged in.                                                                             //
		if (!this.userId) {                                                                                                  // 14
			throw new Meteor.Error('login-require', 'Please login before posting files');                                       // 15
		}                                                                                                                    //
                                                                                                                       //
		return true;                                                                                                         // 18
	},                                                                                                                    //
	maxSize: 0,                                                                                                           // 20
	allowedFileTypes: null                                                                                                // 21
});                                                                                                                    //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
FileUpload = {                                                                                                         // 2
	validateFileUpload: function (file) {                                                                                 // 3
		if (file.size > maxFileSize) {                                                                                       // 4
			throw new Meteor.Error('file-too-large', 'File is too large');                                                      // 5
		}                                                                                                                    //
                                                                                                                       //
		if (!RocketChat.fileUploadIsValidContentType(file.type)) {                                                           // 8
			throw new Meteor.Error('invalid-file-type', 'File type is not accepted');                                           // 9
		}                                                                                                                    //
                                                                                                                       //
		return true;                                                                                                         // 12
	}                                                                                                                     //
                                                                                                                       ...
                                                                                                                       //
var maxFileSize = 0;                                                                                                   // 16
RocketChat.settings.get('FileUpload_MaxFileSize', function (key, value) {                                              // 17
	maxFileSize = value;                                                                                                  // 18
});                                                                                                                    //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
                                                                                                                       //
FileUploadBase = (function () {                                                                                        // 1
	function FileUploadBase(meta, file, data) {                                                                           // 2
		...
		this.file = file;                                                                                                    // 5
                                                                                                                       ...
                                                                                                                       //
	FileUploadBase.prototype.getProgress = (function () {                                                                 // 1
		function getProgress() {}                                                                                            // 8
                                                                                                                       //
		return getProgress;                                                                                                  //
	})();                                                                                                                 //
                                                                                                                       //
	FileUploadBase.prototype.getFileName = (function () {                                                                 // 1
		function getFileName() {                                                                                             // 12
			return this.meta.name;                                                                                              // 13
		}                                                                                                                    //
                                                                                                                       //
		return getFileName;                                                                                                  //
	})();                                                                                                                 //
                                                                                                                       //
	FileUploadBase.prototype.start = (function () {                                                                       // 1
		function start() {}                                                                                                  // 16
                                                                                                                       //
		return start;                                                                                                        //
	})();                                                                                                                 //
                                                                                                                       //
	FileUploadBase.prototype.stop = (function () {                                                                        // 1
		function stop() {}                                                                                                   // 20
                                                                                                                       //
		return stop;                                                                                                         //
	})();                                                                                                                 //
	...
	if (type === 'AmazonS3' && !_.isEmpty(bucket) && !_.isEmpty(accessKey) && !_.isEmpty(secretKey)) {                    // 54
		...
		if (!_.isEmpty(bucketUrl)) {                                                                                         // 90
			config.bucketUrl = bucketUrl;                                                                                       // 91
                                                                                                                       ...
                                                                                                                       //
		Slingshot.createDirective(directiveName, Slingshot.S3Storage, config);                                               // 94
	} else {                                                                                                              //
		if (Slingshot._directives[directiveName]) {                                                                          // 96
			delete Slingshot._directives[directiveName];                                                                        // 97
		}                                                                                                                    //
	}                                                                                                                     //
}, 500);                                                                                                               //
                                                                                                                       //
...
RocketChat.settings.get('FileUpload_S3_AWSSecretAccessKey', function (key, value) {                                    // 113
	...
	createS3Directive();                                                                                                  // 115
                                                                                                                       ...
                                                                                                                       //
RocketChat.settings.get('FileUpload_S3_CDN', createS3Directive);                                                       // 118
                                                                                                                       //
RocketChat.settings.get('FileUpload_S3_Region', createS3Directive);                                                    // 120
                                                                                                                       //
RocketChat.settings.get('FileUpload_S3_BucketURL', createS3Directive);                                                 // 122
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	'sendFileMessage': function (roomId, store, file) {                                                                   // 2
		...
		msg = {                                                                                                              // 40
			...
			attachments: [attachment]                                                                                           // 48
                                                                                                                       ...
                                                                                                                       //
		var msg = Meteor.call('sendMessage', msg);                                                                           // 51
	}                                                                                                                     //
});                                                                                                                    //
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
