...
/////////////////////////////////////////////////////////////////////////
//                                                                     //
// server/startup/migrations/v19.coffee.js                             //
//                                                                     //
/////////////////////////////////////////////////////////////////////////
                                                                       //
    ...
    return _.each(rooms, function(room) {                              //
      ...
      if (creator) {                                                   // 24
        if (Meteor.users.findOne({                                     // 25
          ...
          return console.log(("Add " + room.u.username + " to 'moderator' role").green);
        } else {                                                       //
          RocketChat.models.Subscriptions.removeByRoomId(room._id);    // 29
          RocketChat.models.Messages.removeByRoomId(room._id);         // 29
...
//# sourceMappingURL=v19.coffee.js.map
